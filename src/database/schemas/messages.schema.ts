...
const MessagesSchema = new Schema<IMessagesModel>({
  [Messages_Keys.GroupId]: { type: SchemaTypes.ObjectId, ref: Collections.Groups, required: true },
  ...
  [Messages_Keys.MessageType]: { type: SchemaTypes.String, required: true, default: 'group' },
