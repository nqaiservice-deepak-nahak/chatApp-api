...
import { AbstractDirectChatMetaDao } from './mongodb/abstract/direct-chat-meta.abstract';
...
import { DirectChatMetaDao } from './mongodb/dao/direct-chat-meta.dao';
...
const daoProviders = [
  ...
  { provide: AbstractDirectChatMetaDao, useClass: DirectChatMetaDao }
];
